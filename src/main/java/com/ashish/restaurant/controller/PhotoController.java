...
import com.ashish.restaurant.mappers.PhotoMapper;
import com.ashish.restaurant.services.PhotoService;
        ...
        return photoService.getPhotoAsResource(id).map(photo ->
                ResponseEntity.ok()
                        .contentType(MediaTypeFactory
                                .getMediaType(photo).orElse(MediaType.APPLICATION_OCTET_STREAM)
